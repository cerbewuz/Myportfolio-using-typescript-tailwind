...
const Sidebar = () => {
  return (
    ...
    <div className="fixed h-screen">
      {/* Sidebar Container */}
      <div className="group flex md:p-4">
        {/* Hidden Sidebar */}
        <div className="absolute md:w-24 h-screen bg-transparent flex items-center justify-start h-full">
          <ul className="space-y-2">
            <li className="md:p-4 hover:bg-gray-700 cursor-pointer">
