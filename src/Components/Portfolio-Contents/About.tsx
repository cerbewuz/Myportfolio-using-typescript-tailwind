          ...
          <div>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-3">
              {skills.map((skill) => (
                ...
                >
                  <span
                    className="flex items-center gap-2 px-3 py-1.5 text-xs sm:text-sm font-medium tracking-wide bg-gray-50 dark:bg-[#0c0c0c] text-gray-600 dark:text-gray-300 border border-gray-200/50 dark:border-gray-800/50 rounded-lg transition-all duration-300 cursor-default overflow-hidden"
                    style={{
                      // @ts-ignore
